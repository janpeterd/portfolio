...
<div class="fixed top-0 z-50 flex w-screen justify-between bg-transparent font-elec print:hidden">
  <div
    class="justify-content m-2 flex w-auto items-center rounded-full bg-white/10 backdrop-blur backdrop-saturate-150"
  >
    <NavLink logo={true} href="/" class="relative flex items-center justify-center px-6">
      <LogoImg class="absolute -left-4 -top-8 w-28" />
      <div class="pl-10 font-bold">Portfolio Jan&#8209Peter Dhallé</div>
    </NavLink>
  </div>
  <div
    class="nav-right justify-content m-2 hidden w-1/2 items-center rounded-full bg-white/10 text-white backdrop-blur-lg backdrop-saturate-150 md:flex"
  >
  ...
  <div
    class="nav-right justify-content float-right m-2 flex items-center p-3 text-white md:hidden"
